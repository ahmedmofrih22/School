...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Students_trans.Management_Promotion_students') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 20%">
                                                    ...
                                                    <button type="button" class="btn btn-outline-info"
                                                        data-toggle="modal"
                                                        data-target="#Return_Student{{ $promotion->student_id }}">تخريج
                                                        الطالب </button>

                                                </td>
                                            </tr>
                                            @include(
                                                'pages.Students.promotion.Delete_all'
                                            )
                                            @include(
                                                'pages.Students.promotion.Delete_one'
                                            )
                                            @include(
                                                'pages.Students.promotion.promotion_graduated'
                                            )
                                        @endforeach
                                </table>
                            </div>
