                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item"
                                                                href="{{ route('Students.show', $student->id) }}"><i
                                                                    style="color: #ffc107"
                                                                    class="far fa-eye "></i>&nbsp;{{ trans('Students_trans.View_student_data') }}</a>
                                                            <a class="dropdown-item"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('Fees_Invoices.show', $student->id) }}"><i
                                                                    style="color: #0000cc"
                                                                    class="fa fa-edit"></i>&nbsp;{{ trans('Students_trans.Add_an_invoice_for_fees') }}&nbsp;</a>
                                                            <a class="dropdown-item"
                                                            ...
                                                            <a class="dropdown-item"
                                                                ...
                                                                data-toggle="modal"
                                                                href="##Return_Student{{ $student->id }}"><i
                                                                    style="color: red"
                                                                    class="ti-angle-double-up"></i>&nbsp;
                                                                {{ trans('Students_trans.Student_graduation') }}</a>
                                                            <a class="dropdown-item"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('ProcessingFee.show', $student->id) }}"><i
                                                                    style="color: #9dc8e2;    background: red;
