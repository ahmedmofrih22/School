...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Students_trans.Modify_Processing_Fee') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<h4>
    {{ trans('Students_trans.Modify_Processing_Fee') }} : <label
        style="color: red">{{ $ProcessingFee->student->name }}</label>
</h4>
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card-body">
                ...
                <form action="{{ route('ProcessingFee.update', 'test') }}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label> {{ trans('Students_trans.amount') }} : <span
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('Students_trans.Statement') }} : <span
                                        class="text-danger">*</span></label>
